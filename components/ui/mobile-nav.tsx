...
import {Menu, X, LayoutDashboard, CalendarDays, Target, FileText, LineChart, Sparkles, Activity, Rocket, Globe} from "lucide-react";
...
const items = [
  ...
  { href: "/game-picks", label: "Predicciones", icon: Activity },
  { href: "/picks", label: "Picks", icon: Target },
  { href: "/ai-picks", label: "AI Picks", icon: Sparkles },
  { href: "/soccer-picks", label: "Soccer Picks", icon: Globe },

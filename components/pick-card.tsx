import { Pick } from "@/lib/picks-demo";
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <TeamLogo league="nba" abbr={pick.away_abbr ?? ""} size={26} />
            <span className="text-lg font-semibold">{pick.matchup}</span>
            <TeamLogo league="nba" abbr={pick.home_abbr ?? ""} size={26} />
          </div>

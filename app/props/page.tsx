    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-soft border border-slate-100 p-5 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          >
            {projLoading ? "Calculando..." : "Ejecutar Proyección motor"}
          </button>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          <div className="xl:col-span-2 rounded-2xl bg-white shadow-soft border border-slate-100 p-5 space-y-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-1 text-sm text-slate-600">
                  Proy motor: <span className="font-semibold">{computed.wspmProj.toFixed(1)}</span> • Edge:{" "}
            ...
            <div className="rounded-xl border border-slate-100 bg-white p-4">
              <div className="text-xs text-slate-500">Texto para redes</div>
              <pre className="mt-2 whitespace-pre-wrap text-sm text-slate-800">{`${tierEmoji(computed.tier)} motor • ${
